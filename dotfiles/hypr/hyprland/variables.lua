...
browser = "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'zen-beta' 'zen-browser' 'zen' 'google-chrome-stable' 'firefox' 'brave' 'chromium' 'microsoft-edge-stable' 'opera' 'librewolf'"
